...
|---|---|---|---|
| Tresaurio Kripto Portföy Yönetim Platformu | api-gateway | Go 1.24 | 2026-04-06 |
...
├── docker-compose.yml             # Gateway servisini environment variable'larla ayağa kaldırır
...
| 3 | Rate limiter restart'ta sıfırlanır | Açık | Redis backed rate limiting |
...
*Tresaurio Platform — api-gateway v0.5.0*
